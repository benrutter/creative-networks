...
class ArtDCGAN():
    ...
    def _build_generator(self):
        ...
        generator.add(layers.Dense(128 * self.area_sqrt_by_four * self.area_sqrt_by_four, activation="relu", input_dim=self.latent_dim))
        generator.add(layers.Reshape((self.area_sqrt_by_four, self.area_sqrt_by_four, 128)))
...
test_gan = ArtDCGAN()
test_gan.build_gan()
test_gan.train(3, image_save_interval=1)
